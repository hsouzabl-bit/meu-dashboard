                    ...
                    {miniCalDias.map(({dia,r})=>{
                      ...
                      return (
                        <div key={dia} onClick={()=>r&&setDiaSel(dia===diaSel?null:dia)}
                          style={{height:58,borderRadius:6,background:cor,display:"flex",alignItems:"center",justifyContent:"center",fontSize:12,color:r?th.text:th.textMuted,cursor:r?"pointer":"default",fontWeight:r?700:400}}>
                          {dia}
                        </div>
                      );
                    })}
